            ...
            if (rdiobtnTekCisimTakibi.Checked)
            {
                ...
                foreach (Rectangle recs in rects)
                {
                    if (rects.Length > 0)
                    {
                        ...
                        if (objectX <= 400 && objectY <= 200)
                        {
                            ardino.Write("1");
                        }
                        else if (objectX > 400 && objectX < 800 && objectY <= 200)
                        {
                            ardino.Write("2");
                        }
                        else if (objectX >= 800 && objectY <= 200)
                        {
                            ardino.Write("3");
                        }
                        else if (objectX < 400 && objectY > 200 && objectY < 400)
                        {
                            ardino.Write("4");
                        }
                        else if (objectX > 400 && objectX < 800 && objectY > 200 && objectY < 400)
                        {
                            ardino.Write("5");
                        }
                        else if (objectX > 800 && objectY > 200 && objectY < 400)
                        {
                            ardino.Write("6");
                        }
                        else if (objectX < 400 && objectY > 400)
                        {
                            ardino.Write("7");
                        }
                        else if (objectX > 400 && objectX < 800 && objectY > 400)
                        {
                            ardino.Write("8");
                        }
                        else if (objectX > 800 && objectY > 400)
                        {
                            ardino.Write("9");
                        }
